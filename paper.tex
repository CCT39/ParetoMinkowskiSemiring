...
\begin{figure}[h!]
    ...
    Footage was captured from a 24-hour\footnotemark public YouTube livestream operated by a local arcade \cite{GamePlayFootage}. Gameplay images are used with the expressed permission of the player (i.e., the author).}
    \label{fig:src}
...
% note: 我放在這裡以符合實際排版，實際上這句是跟著圖 figures/src.png 一起的
\footnotetext{Empirically observed as either 22.5 hours (due to routine nightly downtime) or 0 hours (due to hardware entropy).}
